...
class OfrecimientoDiaVista extends StatefulWidget {

  OfrecimientosControlador ofrecimientosControlador;

  OfrecimientoDiaVista(this.ofrecimientosControlador);

  _OfrecimientoDiaVista createState() => _OfrecimientoDiaVista();
}


class _OfrecimientoDiaVista extends State<OfrecimientoDiaVista> {
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed:  _selectedDay != null && franjaController.text.isNotEmpty ? () async {
                  print("TIENE QUE ENTRAR POR AQUI!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! OFRECER DIA" );
                  DateTime fecha = DateTime(_selectedDay!.year,_selectedDay!.month,_selectedDay!.day);
                  widget.ofrecimientosControlador.checkRestriccionesOfrecimientoDia(context, fecha,franjaController.text);
                }
