...
import '../Controladores/NotificacionesControlador.dart';

class PeticionDiaVista extends StatefulWidget {

  PeticionesControlador peticionesControlador;

  PeticionDiaVista(this.peticionesControlador);

  _PeticionDiaVista createState() => _PeticionDiaVista();
}


class _PeticionDiaVista extends State<PeticionDiaVista> {
             ...
             */
              ...
              ElevatedButton(
                ...
                onPressed: activar && _selectedDay != null ? () async {
                  ...
                  widget.peticionesControlador.checkRestriccionesPedirDia(context,widget,fecha,turnoElegido);
                }
  ...
  showAlert(BuildContext context, String mensaje) {
    showDialog(
      context: context,
      builder: (context) {
        Future.delayed(
    ...
    showAlertResumenPeticionDia (BuildContext context, int clave,DateTime fecha) async{
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
          ...
          actions:<Widget>[
            TextButton(
              onPressed: () async{
                //ok = false;
                widget.peticionesControlador.launchPeticionesVista(context);
              },
            ...
            ElevatedButton(
                ...
                onPressed: () async{
                  ...
                  peticionesControlador.guardarPeticion(context,fecha,clave);
                  /*
                  NotificacionesControlador notificacionesControlador = NotificacionesControlador();
                  PeticionesControlador peticionesControlador = PeticionesControlador();
                  peticionesControlador.guardarTurno();
                  peticionesControlador.launchPeticionesVista(context);
                  await notificacionesControlador.sendNotificationEveryDevices(fecha);
